...
function handleVideoQuery(query, popularVideoTreshold) {
  ...
  // check for query strings (filters) related to games
  if (query.name) {
    sql +=
  ...
  // check for query strings (filters) related to promoted videos
  if (query.isPromoted) {
  ...
  // check for query strings (filters) related to popular videos
  if (query.isPopular) {
    sql +=
